            ...
            history: [
              {
                ...
                content: "Esse misto de fascínio e terror encontrado nas narrativas e representações iconográficas fez com que o homem moderno ainda guardasse muito desses valores em seu imaginário. Com o advento da descoberta da América, os colonizadores europeus depararam-se com um mundo onde muitas daquelas situações imaginadas em nada traduziam a situação das chamadas civilizações pré-colombianas. Ao mesmo tempo, essa pré-concepção do outro acabou fazendo do nativo americano algo a ser repudiado e civilizado pelo europeu.\n No entanto, toda essa condição de estranhamento, admiração e repúdio deixou para trás toda uma rica gama de valores culturais desenvolvidas pelos povos que aqui já existiam. No fim do século XV, período que marca a chegada dos espanhóis ao continente, o continente contava com três grandes civilizações: maias, astecas e incas. Muitas das cidades criadas por essas civilizações faziam frente a qualquer centro urbano europeu do século XVI. Mesmo contando com um amplo leque de características e conhecimento, o contato dos nativos com os europeus marcou um dos maiores genocídios que se tem registro.",
                link:"https://youtu.be/0ZjuTWeOFhc"
              },
              {
                lesson: 2,
                title: "As formas de organização social e política: a noção de Estado I.",
                content: "Ao longo da História, a palavra Estado apresenta várias definições. Aqui vamos trabalhar com a ideia de Estado como uma instituição política que apresenta os poderes executivo (executa as leis), legislativo (elabora as leis) e judiciário (julga as leis). Para que um Estado exista de fato é preciso que exista um território, uma população e a soberania de um povo. Também é importante garantir um conjunto de direitos, que chamamos de cidadania, e devem ser garantidos à sociedade. Uma “sociedade” pode ser definida como “um grupo de indivíduos que vive num território, que compartilha as mesmas regras, normas e leis.” A sociedade é a combinação do esforço de todos! Alguns povos da Índia são frequentemente retratados como “atrasados e primitivos”, apenas porque seus meios de sobrevivência em comunidade são diferentes. Essa interpretação gera violências das mais diversas, dentre elas o preconceito que acarreta boa parte dos maustratos enfrentados por esses povos .",
                link: "https://youtu.be/k1Bc8zKqS7g"
              },
              {
                lesson: 3,
                title: "As formas de organização social e política: a noção de Estado II.",
                content: "Ao longo da História, a palavra Estado apresenta várias definições. Aqui vamos trabalhar com a ideia de Estado como uma instituição política que apresenta os poderes executivo (executa as leis), legislativo (elabora as leis) e judiciário (julga as leis). Para que um Estado exista de fato é preciso que exista um território, uma população e a soberania de um povo. Também é importante garantir um conjunto de direitos, que chamamos de cidadania, e devem ser garantidos à sociedade. Uma “sociedade” pode ser definida como “um grupo de indivíduos que vive num território, que compartilha as mesmas regras, normas e leis.” A sociedade é a combinação do esforço de todos! Alguns povos da Índia são frequentemente retratados como “atrasados e primitivos”, apenas porque seus meios de sobrevivência em comunidade são diferentes. Essa interpretação gera violências das mais diversas, dentre elas o preconceito que acarreta boa parte dos maustratos enfrentados por esses povos .",
                link: "https://youtu.be/xbndXunitPE"
              },
              {
                lesson: 4,
                title: "As formas de organização social e política: a noção de Estado III.",
                content: "Ao longo da História, a palavra Estado apresenta várias definições. Aqui vamos trabalhar com a ideia de Estado como uma instituição política que apresenta os poderes executivo (executa as leis), legislativo (elabora as leis) e judiciário (julga as leis). Para que um Estado exista de fato é preciso que exista um território, uma população e a soberania de um povo. Também é importante garantir um conjunto de direitos, que chamamos de cidadania, e devem ser garantidos à sociedade. Uma “sociedade” pode ser definida como “um grupo de indivíduos que vive num território, que compartilha as mesmas regras, normas e leis.” A sociedade é a combinação do esforço de todos! Alguns povos da Índia são frequentemente retratados como “atrasados e primitivos”, apenas porque seus meios de sobrevivência em comunidade são diferentes. Essa interpretação gera violências das mais diversas, dentre elas o preconceito que acarreta boa parte dos maustratos enfrentados por esses povos .",
            ...
            portuguese: [
              {
                ...
                content: "O que é fono ortografia?\n O que é ortografia? A Ortografia estuda a forma correta de escrita das palavras de uma língua. Do grego “ortho”, que quer dizer correto, e “grafo”, por sua vez, que significa escrita. Ela se insere na Fonologia (estudo dos fonemas) e junto com a Morfologia e a Sintaxe são as partes que compõem a gramática.\n O que é a palavra ortográfica?\n substantivo feminino Parte da gramática que contém as regras e preceitos que ensinam a escrever as palavras corretamente, incluindo acentuação, pontuação, crase etc. [Gramática] Estudo dessa parte da gramática e de suas regras. Maneira de escrever as palavras; talhe de letra; grafia.\n Como é feita a ortografia?\nA ortografia se encarrega de determinar o uso correto das letras e dos sinais de acentuação e de pontuação. Ao estabelecer as normas de escrita, a ortografia segue critérios etimológicos e fonológicos. A forma de escrita é fruto de acordos entre países que possuem o mesmo idioma.",
                link: "https://youtu.be/a1ic6i4NamM"
              },
              {
                lesson: 2,
                title: "Estratégia de leitura: apreender os sentidos globais do texto I",
                content: "As estratégias de leitura reúnem as diversas técnicas e métodos que facilitam a leitura e, consequentemente, a compreensão dos textos. Praticamos a leitura com finalidades específicas seja para estudar, aprender, entreter, obter alguma informação, dentre outros.  Veja abaixo os principais técnicas que auxiliam no processo de leitura. Para compreender melhor um texto é importante ressaltar que temos que ler com calma cada parágrafo. Se não compreender, volte e releia. E ainda, se aparecer algum termo que não saiba o significado, o importante é recorrer ao dicionário e voltar ao texto. Tal qual um resumo, vale apontar os principais temas e/ou assuntos abordados pelo texto. Por isso, a técnica indicada acima é muito importante e complementa esta técnica. Portanto, leia com atenção, e aos poucos vá assinalando as palavras-chave do texto. Esse recurso é muito interessante perceber no momento em que estamos lendo o texto. Assim, o conceito de “ler nas entrelinhas” define a leitura que fazemos além do texto, ou seja, baseia-se nas adivinhações e inferências que realizamos e que não está escrito em palavras no texto.",
                link: "https://youtu.be/TKSm1nbmVlo"
              },
              {
                lesson: 3,
                title: "Estratégia de leitura: apreender os sentidos globais do texto II",
                content: "Além da importância da leitura na vida social e para ampliação do universo cognitivo, adquirir o hábito da leitura facilitará cada vez mais a compreensão dos textos. A partir disso, o vocabulário, a imaginação e a criatividade aumentam, e não somente o texto escrito, mas a produção de texto oral, melhora muito. Em resumo, quanto mais lemos, melhores leitores nos tornamos. Se possível, realize a leitura do texto em voz alta e perceba toda sua estruturação, desde palavras, virgulas, discursos, etc. Em muitos casos, isso facilita a leitura e a compreensão dos textos. No entanto, algumas pessoas preferem ler em silêncio. Portanto, faça o teste e veja o que você prefere. Outra boa estratégia de leitura é variar o tipo de texto que se lê, de forma que a abordagem de cada um é diferente bem como seu conteúdo; e isso ampliará ainda mais sua compreensão. Assim, leia livros, jornais, revistas, quadrinhos, textos acadêmicos, etc. Isso também facilitará a interpretação, aumentando seu vocabulário. Note que a linguagem pode variar de formal para informal, e ainda de verbal e não-verbal (imagens, fotos, gráficos, etc) dependendo do tipo de texto.",
            ...
            science: [
              {
                ...
                content: "O processo de separação de misturas é muito relevante, pois a maioria dos materiais encontrados na natureza não é substância pura, ou seja, não é constituída de um único tipo de partículas ou moléculas; mas, na verdade, trata-se de misturas compostas de duas ou mais substâncias diferentes.\n Mas a separação dos componentes dessas misturas ou o fracionamento delas (ou ainda sua análise imediata) são importantes para vários aspectos de nossa vida, como para separar os poluentes da água e torná-la própria para consumo, na produção de metais e de componentes especiais que são usados para produzir medicamentos, alimentos, bebidas, produtos de higiene e limpeza; na obtenção do sal de cozinha, na análise dos componentes do sangue nos laboratórios, para separar os componentes do lixo e destiná-los ao tratamento correto ou para reciclagem e assim por diante.\n No entanto, visto que as composições variam, para realizar a separação de misturas, é necessário aplicar técnicas ou métodos especiais para cada caso. As técnicas podem ser físicas ou químicas, pois o princípio fundamental é usar as propriedades dos componentes das misturas para separá-las. Essas propriedades podem ser o ponto de fusão, o ponto de ebulição, a solubilidade, a densidade, entre outros.",
                link: "https://youtu.be/X5OWOAp7t-I"
              },
              {
                lesson: 2,
                title: "Célula como unidade dos seres vivos Célula como unidade da vida I",
                content: "As células são estruturas microscópicas que fazem parte da organização do corpo dos seres vivos. Essa estrutura foi inicialmente descrita por Robert Hooke ao analisar um corte de cortiça. O termo célula vem do latim cella, que significa pequeno compartimento, e faz referência ao que Hooke visualizou ao analisar o corte do vegetal. Por ter observado células mortas, o pesquisador viu apenas a parede celular das células vegetais e, por isso, achou que se tratava de um compartimento, e não uma estrutura viva e complexa. É comum dizer que uma célula é composta por três partes básicas: membrana plasmática, citoplasma e núcleo. Essa informação, no entanto, é incorreta quando analisamos alguns tipos de células. Todas as células possuem membrana plasmática e citoplasma, mas o núcleo é estrutura ausente em células procariontes. Nesse tipo celular, o material genético está disperso no citoplasma. Assim sendo, analisando a estrutura básica de uma célula, podemos classificá-la em procarionte e eucarionte. Procariontes são aquelas que não possuem um núcleo definido envolto por membranas. Já a célula eucarionte apresenta um núcleo delimitado pelo envoltório nuclear, possuindo, portanto, uma proteção ao seu material genético.",
                link: "https://youtu.be/L4smfNoMKb8"
              },
              {
                lesson: 3,
                title: "Célula como unidade dos seres vivos Célula como unidade da vida II",
                content: "Além da diferença no que diz respeito ao núcleo, as células procariontes ainda apresentam diferenças quando comparadas às eucariontes. Em procariontes, por exemplo, não existem organelas citoplasmáticas envolvidas por membranas, como a mitocôndria e o retículo endoplasmático. As células eucariontes, por sua vez, são células mais complexas, maiores e possuem organelas membranosas. Como vimos, uma célula obrigatoriamente possui uma membrana plasmática, um citoplasma e um material genético que pode ou não estar em um núcleo definido. A seguir vamos falar um pouco sobre cada uma dessas importantes partes. A membrana plasmática proporciona a seleção de substâncias que entram e saem da célula, uma propriedade conhecida como permeabilidade seletiva. Moléculas pequenas, como oxigênio e água, passam pela membrana por processo de difusão simples. Já moléculas maiores e carregadas, como íons e glicose, são transportadas por difusão facilitada. Substâncias que entram na célula contra um gradiente eletroquímico fazem-no por um processo chamado de transporte ativo. Existem ainda aquelas que entram por invaginações da membrana (endocitose) e aquelas que saem e virtude da fusão de vesículas à membrana (exocitose).",
                link: "https://youtu.be/DC1uBdvFG3k"
              }
            ]
          }
        ]
            ...
            portuguese: [
              {
                ...
                content: "O anúncio publicitário (ou simplesmente publicidade) é um gênero textual que promove um produto ou uma ideia sendo veiculado pelos meios de comunicação de massa: jornais, revistas, televisão, rádio e internet. \nPodemos encontrá-los também em outdoors, panfletos, faixas ou cartazes na rua, no ônibus, no metrô, etc. \nA principal característica desses tipos de textos são precisamente o convencimento do consumidor para a compra de um produto ou serviço. \nOs publicitários, ou seja, aqueles que produzem os anúncios publicitários, utilizam diversas ferramentas discursivas, por exemplo, uso de imagens, de linguagem simples e humor. \nNote que esse tipo de texto tem como intuito chamar a atenção do consumidor e, portanto, são atrativos. São repletos de verbos no imperativo, o modo verbal que oferece ordem: Compre! Veja! Analise! \nDe acordo com as funções da linguagem, os anúncios publicitários são textos que apresentam a função conativa ou apelativa, que por sua vez possuem o intuito de convencer os receptores da mensagem, ou seja, os consumidores. \nPodem ser textos verbais (palavras) e não verbais (uso de imagens), e ainda textos orais, por exemplo, aqueles veiculados pelo rádio.",
                link: "https://youtu.be/SQFtLCDvCIU"
              },
              {
                lesson: 2,
                title: "Produzindo um dialogo",
                content: "Aprender como escrever diálogos eficazes é uma parte essencial da carreira literária de qualquer escritor, independe do seu gênero literário. Por sua vez, o diálogo mal construído pode fazer os leitores desanimarem do seu livro, mas um bom diálogo pode transformas seus personagens em pessoas reais e seus leitores em clientes satisfeitos.\nUm bom diálogo não é apenas verossímil, mas também dispõem de exposição da cena, com linguagem única de quem está falando e coopera para mover sua história para frente. Sem diálogo, você têm apenas páginas e páginas de descrição com pouca ou nenhuma dinâmica entre os personagens.\nComo uma das ferramentas de escrita mais poderosas, escrever diálogos naturais ajuda você a produzir um livro forte e com mensagem poderosa. Caso for sua intenção. Agora, vou te ajudar em como escrever diálogos com dez passos práticos e fáceis.Parafraseando, Alfred Hitchcock, “O drama é a vida com as partes maçantes cortadas”. Da mesma forma, podemos afirmar que um bom diálogo é como uma conversa natural sem todos os floreios. Portanto, não tenha pressa em escrever seus diálogos, deixe que surjam quando for apropriado dentro do enredo.",
                link: "https://youtu.be/Bk1tjeUqb2s"
              },
              {
                lesson: 3,
                title: "Como fazer um texto prescritivo",
                content: "Textos injuntivos e textos prescritivos são textos cuja finalidade é a instrução do leitor. Não só fornecem uma informação, como incitam à ação, guiando a conduta do leitor.\n Embora considerados sinônimos por alguns autores, podemos distinguir os textos injuntivos dos textos prescritivos devido ao grau de obrigatoriedade existente no seguimento das instruções dadas. Os textos injuntivos informam, ajudam, aconselham, recomendam e propõem, dando alguma liberdade de atuação ao interlocutor. Os textos prescritivos obrigam, exigem, ordenam e impõem, exigindo que as determinações sejam cumpridas da forma que estão referidas, sem margem para alterações.",
            ...
            science: [
              {
                ...
                content: "Ao olhar para o céu, vemos o passado de objetos distantes porque a luz pode levar até milhões de anos para sair de um corpo celeste e chegar à Terra. Só podemos enxergar os objetos que nos cercam porque eles estão emitindo ou refletindo luz, que, ao atingir nossos olhos, proporciona a formação nítida de imagens.\n Para observar estrelas e planetas, o ideal é ir para um lugar afastado, longe das luzes da cidade. Visite um local apropriado durante o dia e confira as condições de segurança e mobilidade para que, à noite, você saiba o quanto pode se deslocar em volta do seu equipamento.\n Vale lembrar que, ao olharmos para o céu noturno, estamos olhando para o passado; quanto mais longe o objeto, mais tempo para a sua luz chegar até nós. Portanto, quando dizemos que um objeto está a 13 bilhões de anos-luz de distância, isso significa que a luz que vemos hoje saiu dele há 13 bilhões de anos.",
                link: "https://youtu.be/C7EU-9H9748"
              },
              {
                lesson: 2,
                title: "Representando o sistema solar",
                content: "O Sistema Solar é uma estrutura astronômica formada por oito planetas, além de diversos outros corpos celestes, que orbitam o Sol. Sua origem, conforme estudos científicos diversos, foi possível mediante o colapso de uma nuvem de objetos celestes. O Sistema Solar é formado por oito planetas: Mercúrio, Vênus, Terra, Marte, Júpiter, Saturno, Urano e Netuno. Já Plutão, anteriormente classificado como planeta, foi rebaixado para planeta anão. Além dos planetas, há diversos corpos celestes que fazem parte do nosso sistema, como os satélites naturais, além de asteroides, cometas e meteoroides.\n A  formação do Sistema Solar ainda é motivo de controvérsias entre cientistas. No entanto, a principal teoria aceita pela comunidade científica internacional é a da nebulosa solar, que defende que os corpos celestes são resultantes do colapso de uma grande nuvem de elementos celestes.\n Dessa forma, a explosão dessa nuvem deu origem ao Sol e, consequentemente, ao demais corpos celestes constituintes do Sistema Solar, como planetas e satélites naturais. Tal teoria ainda é objeto de discussão em todo o mundo e vem sendo constantemente aperfeiçoada mediante o avanço dos estudos científicos",
                link: "https://youtu.be/zQvpKm9dCD0"
              },
              {
                lesson: 3,
                title: "As caracteristicas basicas dos seres vivos",
                content: "As principais características dos seres vivos são a sua composição química comum, a presença de células, o metabolismo, a capacidade de reprodução e a evolução. \n Quando vemos um animal, sabemos que se trata de um ser vivo, não é mesmo? Mas, afinal, o que define um ser como um organismo vivo? Que característica um organismo deve possuir para ser classificado como uma forma de vida? Essas respostas, apesar de parecerem simples, são muito mais complexas do que podemos imaginar, uma vez que determinados organismos não se encaixam em determinados quesitos mesmo se comportando como uma forma de vida. \n Todos os organismos vivos apresentam determinados tipos de elementos químicos. São eles: carbono, hidrogênio, oxigênio e nitrogênio. Além desses elementos, também encontramos fósforo e enxofre, mas em menor quantidade.",
                link: "https://youtu.be/C7EU-9H9748"
              }
            ]
          }   
            ...
            science: [
              {
                ...
                content: "A biodiversidade pode ser definida, de maneira resumida, como a riqueza de espécies de um ecossistema. Esse conceito relaciona-se com o número de espécies de um local mas também com a variação entre organismos da mesma espécie e sua abundância. Utilizado como sinônimo de diversidade biológica, o conceito de biodiversidade é essencial na ecologia e utilizado desde a década de 1980. \nAtualmente ouvimos falar muito da biodiversidade, principalmente da sua perda. Com o aumento das cidades e da atividade humana, muitos ambientes são destruídos e as mudanças climáticas tornam-se uma realidade cada vez mais inevitável. Com isso, temos uma redução da biodiversidade, que desencadeia prejuízo para o meio ambiente e até mesmo para a economia. Biodiversidade é um termo que designa a variedade de seres vivos de uma região, bem como a variação dos organismos dentro da mesma espécie. O termo em questão foi utilizado pela primeira vez em 1986, no 1º Fórum Americano Sobre Diversidade Biológica, organizado pelo Conselho Nacional de Pesquisa dos EUA (National Research Council, NRC, em inglês), pelo entomologista E. O. Wilson. Ele foi cunhado como sinônimo da expressão “diversidade biológica”, já utilizada.",
                link: "https://youtu.be/DFsF4wML-VM"
              },
              {
                lesson: 2,
                title: "Endemias e epidemias",
